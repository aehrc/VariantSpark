...
// MAGIC %md
// MAGIC example output from Cmd 16
// MAGIC ![VariantSpark-SQL](https://s3.us-east-2.amazonaws.com/csiro-graphics/notebook-images/VS-SQL.png)
...
// MAGIC %md
// MAGIC example output from Cmd19  
// MAGIC ![VariantSpark-Python](https://s3.us-east-2.amazonaws.com/csiro-graphics/notebook-images/VS-Python.png)
...
// MAGIC %md 
// MAGIC example output from Cmd24  
// MAGIC ![VariantSpark-R](https://s3.us-east-2.amazonaws.com/csiro-graphics/notebook-images/VS-R.png)
...
// MAGIC %md 
// MAGIC example output from Cmd 34  
// MAGIC ![VariantSpark-Hail](https://s3.us-east-2.amazonaws.com/csiro-graphics/notebook-images/VS-Hail.png)
