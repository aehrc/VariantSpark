...
/**
  * We will base our classification from here: http://www.abs.gov.au/websitedbs/a3121120.nsf/home/statistical+language+-+what+are+variables
...
object VariableType {
  val BOUNDED_ORDINAL_RE = """ORDINAL\((\d+)\)""".r
  val BOUNDED_NOMINAL_RE = """NOMINAL\((\d+)\)""".r
