...
/**
 * A command to generate an synthetic population based on family specificiation
 */
class GeneratePopulationCmd extends ArgsApp with SparkApp with Logging with TestArgs with Echoable {
