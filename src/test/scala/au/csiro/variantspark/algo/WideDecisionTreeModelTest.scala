...
class WideDecisionTreeModelTest extends SparkTest {
  ...
  def testCorrectlyPredictsComplexTree() {
    ...
    val decisionTreeModel = new DecisionTreeModel(SplitNode(majorityLabel = 0, size = 10,
        ...
        right = SplitNode(majorityLabel = 0, size = 10, nodeImpurity = 0.0, splitVariableIndex = 2L, splitPoint = 0.0, impurityReduction = 0.0, left = LeafNode(2, 0, 0.0), right = LeafNode(3, 0, 0.0))))
    val data = sc
  ...
  def testCorrectlyIdentifiedVariableImportanceForComplexTree() {
    ...
    val decisionTreeModel = new DecisionTreeModel(SplitNode(majorityLabel = 0, size = 10,
        ...
        left = SplitNode(majorityLabel = 0, size = 4, nodeImpurity = 0.4, splitVariableIndex = 2L, splitPoint = 0.0, impurityReduction = 0.0, left = LeafNode(2, 3, 0.2), right = LeafNode(3, 1, 0.1)),
