...
case class TestClassificationPredictorWithImportance(val predictions: Array[Int],
...
case class TestRegressionPredictorWithImportance(val predictions: Array[Double],
    val importance: Long2DoubleOpenHashMap, val splitCounts: Long2LongOpenHashMap)
    extends PredictiveModelWithImportance {
