...
def main():
    ...
    data = vc.import_vcf(os.path.join(PROJECT_DIR, 'data/chr22_1000_GRCh38.vcf'))
    ...
    rf_model.export_to_json(os.path.join(PROJECT_DIR, "target/chr22_1000_GRCh38-model.json"), True)
