...
class LocalFdrModel(NamedTuple):
    """
    ...
    def fit(cls, z, pvalue=0.05):
        ...
        C = skewnorm.ppf(1 - pvalue, **initial_f0_params._asdict())
        ...
        return LocalFdrModel(x, f_observed_y, f_y, C, f0_params, f0_y, p0,
                             local_fdr)
