# -*- coding: utf-8 -*-
#
# VariantS documentation build configuration file, created by
...
# add python sources and dependecies to the list
...
latex_documents = [
    (master_doc, 'VariantS.tex', u'VariantS Documentation',
     u'Piotr Szul', 'manual'),
]
...
man_pages = [
    (master_doc, 'variants', u'VariantS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'VariantS', u'VariantS Documentation',
     author, 'VariantS', 'One line description of project.',
     'Miscellaneous'),
]
